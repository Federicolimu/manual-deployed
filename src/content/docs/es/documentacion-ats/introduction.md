...
- Integrar las necesidades comerciales, operativas y de staffing en un mismo flujo.
- Reducir el tiempo de respuesta frente a clientes y talento disponible.

## ¿A quién está dirigido este manual?

- **Recruiters:** responsables del contacto directo con candidatos.
